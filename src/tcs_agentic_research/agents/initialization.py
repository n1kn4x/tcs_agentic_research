...
class InitializationAgent:
    ...
    def commit_bundle(
        ...
        # canonical claim ledger with unproven claims. New scientific claims are generated by
        # obligation runs and appended to ClaimLedger.jsonl only after deterministic gates pass.
