...
Terminate only if the main task is solved, all central claims have adequate evidence, complexity/resource derivations are complete, and independent replication has confirmed the result. Otherwise request continuation or independent replication for a possible breakthrough.
